...
class Spider(BaseSpider):
    def __init__(self):
        ...
        # 混沌青莲·万身缓存：分类/搜索时缓存正确标题，详情页直接取用
        self._title_cache = {}
    ...
    def _clean(self, text):
        ...
        # 太阳神炉·高温清洗：先整块焚毁 script/style/svg
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        for block in blocks:
            ...
            if vid and title:
                self._title_cache[vid] = title  # 混沌青莲·缓存真身
    ...
    def searchContent(self, key, quick, pg="1"):
        ...
        for block in blocks:
            ...
            if vid and title:
                self._title_cache[vid] = title  # 搜索也缓存
                videos.append({"vod_id": vid, "vod_name": title, "vod_pic": pic, "vod_remarks": ""})
