...
if __name__ == "__main__":
    ...
    # formatJo = sp.categoryContent('actor', '1', False, {'region_id':'37506951151616005'})  # 分类
    # formatJo = sp.detailContent(['144587640082006021'])  # 详情
    # formatJo = sp.playerContent("","https://www.yingmeng.net/vodplay/140148-2-1.html",{}) # 播放
    # formatJo = sp.localProxy({"url":"https://pre-mvsdl3.cqpwg.com/IDG5469/cover_h_241029033657.bin","type":"image"}) # 播放
    pprint(formatJo)
