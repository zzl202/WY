...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        result['class'].append({'type_id': '/t/141', 'type_name': '番號'})
        result['class'].append({'type_id': '/t/1', 'type_name': '有码'})
        result['class'].append({'type_id': '/t/5', 'type_name': '无码'})
        result['class'].append({'type_id': '/t/32', 'type_name': '巨乳无码'})
        result['class'].append({'type_id': '/t/34', 'type_name': '人妻无码'})
        result['class'].append({'type_id': '/t/35', 'type_name': '制服无码'})        
        result['class'].append({'type_id': '/t/223', 'type_name': '乱伦无码'})
        result['class'].append({'type_id': '/t/224', 'type_name': '强奸无码'})        
        result['class'].append({'type_id': '/t/36', 'type_name': '丝袜美腿'})
        result['class'].append({'type_id': '/t/13', 'type_name': '中文字幕'})
        result['class'].append({'type_id': '/t/53', 'type_name': '绝美少女'}) 
        result['class'].append({'type_id': '/t/6', 'type_name': '强奸乱伦'})
        result['class'].append({'type_id': '/t/7', 'type_name': '巨乳'})
        result['class'].append({'type_id': '/t/9', 'type_name': '制服诱惑'})
        result['class'].append({'type_id': '/t/11', 'type_name': '调教'})
        result['class'].append({'type_id': '/t/58', 'type_name': '口爆'})
        ...
        result['class'].append({'type_id': '/t/2', 'type_name': '传媒'})
        result['class'].append({'type_id': '/t/163', 'type_name': '视频'})        
        result['class'].append({'type_id': '/t/67', 'type_name': '空姐模特'})
        result['class'].append({'type_id': '/t/69', 'type_name': '学生'})
        result['class'].append({'type_id': '/t/70', 'type_name': '人妻熟女'})
        result['class'].append({'type_id': '/t/71', 'type_name': '乱伦'})
        result['class'].append({'type_id': '/t/72', 'type_name': '自慰'})
        result['class'].append({'type_id': '/t/73', 'type_name': '野合车震'})
        result['class'].append({'type_id': '/t/75', 'type_name': '名人'})
        result['class'].append({'type_id': '/t/74', 'type_name': 'OL'})
        result['class'].append({'type_id': '/t/18', 'type_name': '剧情'})
        result['class'].append({'type_id': '/t/19', 'type_name': '偷怕'})
        result['class'].append({'type_id': '/t/76', 'type_name': '网曝'})        
        ...
        result['class'].append({'type_id': '/t/141', 'type_name': '番号'})
