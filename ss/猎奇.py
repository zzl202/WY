...
class Spider(BaseSpider):
    ...
    def homeContent(self, filter):
        classes = [
            ...
            {'type_name': '人妻斬', 'type_id': '/marriedslash'},
            {'type_name': '頑皮4610', 'type_id': '/naughty4610'},
            {'type_name': '頑皮0930', 'type_id': '/naughty0930'},
            {'type_name': 'TWAV', 'type_id': '/twav'},
            {'type_name': 'Furuke', 'type_id': '/furuke'},
            {'type_name': '韓國直播', 'type_id': '/klive'},
            {'type_name': '中國直播', 'type_id': '/clive'},
            {'type_name': '抖阴视频', 'type_id': '/tiktok'},
            {'type_name': '明星换脸', 'type_id': '/starface'},
            {'type_name': '主播直播', 'type_id': '/cnlive'},
            {'type_name': '国产传媒', 'type_id': '/cmedia'},
            {'type_name': '玩偶姐姐', 'type_id': '/playgirl'},
            {'type_name': '网曝门', 'type_id': '/netdoor'},
        ]
